...
def fetch_user(token_info):
    ...
    return format_user(sp.me(), token_info)
...
def fetch_albums(album_ids):
    ...
    return format_all(sp.albums(album_ids), format_album)
...
def fetch_artists(artist_ids):
    ...
    return format_all(sp.artists(artist_ids), format_artist)
...
def fetch_tracks(track_ids, limit=50):
    ...
    return format_all(sp.tracks(track_ids), format_track)
